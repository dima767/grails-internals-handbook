...
As you could see it is a high level Gant script that relies on the lower level targets of the 'system' scripts (the one prefixed with underscore). Let's bisect those targets one by one i.e. @checkVersion@, @configureProxy@, @packageApp@, @parseArgumnets@
